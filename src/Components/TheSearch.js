...
const TheSearch = ({placeholder, onClick, isLoading = false}) => {
  return (
    <div css={tw`container px-4 sm:px-12 relative block`}>
      <div tw="absolute -top-9 left-4 right-4 sm:left-12 sm:right-12">
        ...
        <div tw="mt-1 relative lg:w-1/2 mx-auto">
          ...
          <input type="text" name="company-website" id="company-website"
                 ...
                 placeholder={placeholder} onChange={onClick} disabled={isLoading}/>
        </div>
      </div>
    </div>
  )
